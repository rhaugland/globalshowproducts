...
export default function CollectionPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      <h1 className="mt-4 text-3xl font-bold text-navy">{collection.title}</h1>
      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        <select
          ...
          className="rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm text-charcoal focus:border-navy focus:outline-none focus:ring-1 focus:ring-navy"
        >
